...
public class AuthenticationController {
    ...
    public String processRegistrationForm(
            @ModelAttribute @Valid RegisterFormDTO registerFormDTO, Errors errors, HttpServletRequest request,
            Model model) {
        if(errors.hasErrors()){
            model.addAttribute("title", "Register");
            return "register";
        ...
        if(existingUser!= null){
            errors.rejectValue("username", "username.alreadyexists", "A user with" +
    ...
    public String processLoginForm(@ModelAttribute @Valid LoginFormDTO loginFormDTO,
        ...
        if (theUser == null) {
            errors.rejectValue("username", "user.invalid",
                    "The given username does not exists");
            model.addAttribute("title", "log in");
            return "login";
        }
